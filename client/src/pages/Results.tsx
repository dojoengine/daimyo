              ...
              >
                ...
                <div className="results-entry-main">
                  ...
                  <div className="results-entry-chips">
                    ...
                    {r.entry.video_url && (
                      <a href={r.entry.video_url} target="_blank" rel="noopener noreferrer" className="results-action-link results-video-link">
                        <VideoIcon />
                        <span>Watch Demo</span>
                      </a>
                    )}
                    {r.entry.repo_url && (
                      <a href={r.entry.repo_url} target="_blank" rel="noopener noreferrer" className="results-action-link results-code-link">
                        <CodeIcon />
                        <span>View Code</span>
                      </a>
                    )}
